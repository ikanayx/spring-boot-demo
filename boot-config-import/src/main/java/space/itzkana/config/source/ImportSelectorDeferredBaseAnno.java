...
public class ImportSelectorDeferredBaseAnno implements DeferredImportSelector {
    @Override
    public String[] selectImports(AnnotationMetadata importingClassMetadata) {
        ...
        Map<String, Object> map = importingClassMetadata.getAnnotationAttributes(EnableAnimalDeferred.class.getName(), true);
        if (map != null) {
